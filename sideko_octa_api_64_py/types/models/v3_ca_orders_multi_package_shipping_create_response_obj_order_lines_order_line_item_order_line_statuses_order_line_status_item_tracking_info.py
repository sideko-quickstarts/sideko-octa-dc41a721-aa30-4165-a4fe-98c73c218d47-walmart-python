...
class V3CaOrdersMultiPackageShippingCreateResponseObjOrderLinesOrderLineItemOrderLineStatusesOrderLineStatusItemTrackingInfo(
    pydantic.BaseModel
):
    """
    ...
    """
    carrier_name: V3CaOrdersMultiPackageShippingCreateResponseObjOrderLinesOrderLineItemOrderLineStatusesOrderLineStatusItemTrackingInfoCarrierName = pydantic.Field(
        alias="carrierName",
    )
    """
