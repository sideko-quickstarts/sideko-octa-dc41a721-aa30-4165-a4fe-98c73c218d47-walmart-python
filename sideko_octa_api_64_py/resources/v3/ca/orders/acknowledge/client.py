...
class AcknowledgeClient:
    ...
    def create(
        ...
        *,
        ...
        POST /v3/ca/orders/{purchaseOrderId}/acknowledge
        ...
        Examples:
        ```py
        client.v3.ca.orders.acknowledge.create(
        ...
        return self._base_client.request(
            method="POST",
            path=f"/v3/ca/orders/{purchase_order_id}/acknowledge",
            headers=_header,
...
class AsyncAcknowledgeClient:
    ...
    async def create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.v3.ca.orders.acknowledge.create(
            wm_consumer_channel_type="string",
            wm_consumer_id="Get the Consumer ID from Developer Center after logging in",
            wm_qos_correlation_id="b3261d2d-028a-4ef7-8602-633c23200af6",
            wm_sec_auth_signature="9fg3TPeRt0WSGbXNGGj4kSQ9L6PMBX.....9Zj5aDyg=",
