...
class CancelClient:
    ...
    def create(
        ...
        *,
        ...
        wm_svc_name: str,
        order_lines: params.V3CaOrdersCancelCreateBodyOrderLines,
        ...
        POST /v3/ca/orders/{purchaseOrderId}/cancel
        ...
        Args:
            ...
            orderLines: Container for the cancellation details
        ...
        Examples:
        ```py
        client.v3.ca.orders.cancel.create(
        ...
        return self._base_client.request(
            method="POST",
            path=f"/v3/ca/orders/{purchase_order_id}/cancel",
            headers=_header,
            content=_content,
...
class AsyncCancelClient:
    ...
    async def create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.v3.ca.orders.cancel.create(
            wm_consumer_channel_type="string",
            wm_consumer_id="Get the Consumer ID from Developer Center after logging in",
            wm_qos_correlation_id="b3261d2d-028a-4ef7-8602-633c23200af6",
            wm_sec_auth_signature="9fg3TPeRt0WSGbXNGGj4kSQ9L6PMBX.....9Zj5aDyg=",
